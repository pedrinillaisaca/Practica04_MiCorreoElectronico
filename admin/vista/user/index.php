...
//echo"<p>".$u_codigo."</p>";
 ...
 echo "<h2><a href='modificar_user2.php?u_codigo=".$u_codigo."&u_nombre=".$u_nombre."'>Modificar datos</a></h2>";
 echo "<h2><a href='cambiar_contra_usuario.php?u_codigo=".$u_codigo."&u_nombre=".$u_nombre."'>Cambiar contraseña</a></h2>";
