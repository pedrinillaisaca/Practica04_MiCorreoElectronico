...
<body>
    ...
    $u_codigo = $_POST["u_codigo"];//parametros de usuario
    $u_nombre = $_POST['u_nombre'];//parametros de usuario
    ...
    $conn->close();
    header("Location: ../../vista/user/agreInvitados2.php?u_codigo=$u_codigo&u_nombre=$u_nombre"); //redirecciono a la pagina para adicionar a los invitados
